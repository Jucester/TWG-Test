...
class PublicationPolicy
{
    ...
    {
        // Revisar que solo el usuario autenticado pueda ver la ruta de edición de la publicación
    ...
    {
        // Revisar que el usuario que desea editar la publicación sea su creador
        return $user->id === $publication->user_id;
    }
    ...
    {
        // Para checkear que el user que elimina es el creador
        return $user->id === $publication->user_id;
    }   
